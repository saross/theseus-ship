# v1-Metadata-FAIMS-o3

## Metadata
- **Conversation ID:** `6814cda4-6f40-800c-a49d-598cb1e6de85`
- **Created:** 2025-05-02 15:50:28
- **Updated:** 2025-12-07 21:39:38
- **Default Model:** `o3`
...
* Platform. The underlying platform associated with a 'Packages and libraries'-category tool. These tools may be plugins, exensions, or scripts associated with other software such as ArcGIS, QGIS, AutoCAD, LibreOffice Calc, Open Data Kit, etc. OR they may be *published packages* in a package repository such as CRAN or PyPi (in which case insert the associated programming language: R, Python, Lisp, etc.).
...
### Assistant (15:50:28) [Model: o3]

Yes. I understand the ground rules, the definition of a research-software tool, the required CSV structure, the evaluation criteria, and the workflow you expect (one tool at a time, exhaustive searching, accurate sourcing, single quoted CSV line inside a fenced code block, Australian English). Please give me the first tool name when you’re ready, and I’ll begin the deep-dive research.
...
### Assistant (15:51:45) [Model: o3]

RESULTS:
```csv
"Tool","Description","Tool-status","Tool-status-reasoning","DVCS-repo","CRAN","PyPi","Other-URL","Category","Language","Platform","License","Type","Lifecycle-stage","Interoperability","Strenghths","Weaknesses","Survivability","Alternatives","Authors","Tags"
"FAIMS","Open-source mobile and web platform (FAIMS Mobile / FAIMS3) that lets researchers build custom electronic field notebooks for offline data capture, synchronisation and FAIR-compliant export—created for archaeology but now used across many field-research disciplines.","yes","FAIMS embodies disciplinary workflows, transforms raw observations into structured digital data, and is cited in scholarly research; it therefore squarely fits the definition of a research software tool.","https://github.com/FAIMS/FAIMS3","","","https://faims.edu.au","Stand-alone software","TypeScript|Java|JavaScript","Android|iOS|Desktop","GPL-3.0","Research-specific","Data collection|Data management","Exports CSV|JSON|GeoJSON; integrates with Heurist|tDAR; GIS-friendly","Highly customisable; offline operation; cross-platform; open-source; FAIR-aligned","Server deployment and advanced customisation require technical skill; legacy Android-only v2 deprecated","Active: funded by ARDC (2023-2025) and shows frequent commits; good medium-term outlook but grant-dependent","Codifi|ODK|KoBoToolbox|ArcGIS Field Maps|Fulcrum","Shawn Ross|Adela Sobotkova|Brian Ballsun-Stanton|Jared Berghold|Rini Angreani","Data collection|Data management"
```

### Sources  
The FAIMS 3.0 project homepage summarises the platform’s purpose, history and cross-platform rewrite citeturn0search0.  
Early project documentation details its origins in archaeology and open-source design citeturn0search2.  
The DH-Abstracts record confirms FAIMS’ initial archaeological focus and modular approach citeturn0search1.  
The EADH project page describes FAIMS Mobile as an offline, multi-user data-collection system citeturn0search3.  
A peer-reviewed SoftwareX article outlines the Android architecture and Ubuntu server back-end of FAIMS Mobile v2 citeturn0search5.  
The JCAA paper discusses the platform’s implementation of FAIR data principles across 40+ projects citeturn0search12.  
GitHub organisation listings show the active FAIMS3 monorepo and recent commit activity citeturn1search0.  
The FAIMS3 repository README and release notes indicate the GPL-3.0 licence and multi-app monorepo structure citeturn1search7turn1search8.  
The archived faims-android repo documents deprecation of the legacy v2 codebase citeturn1search2.  
Auxiliary FAIMS Tools scripts illustrate interoperability and export utilities for GIS-ready formats citeturn1search3.
